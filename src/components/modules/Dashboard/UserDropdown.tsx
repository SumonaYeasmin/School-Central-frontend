...
export function UserDropdown({ user }: UserDropdownProps) {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-64 bg-white border-slate-200 text-slate-700 p-2 shadow-xl shadow-slate-200/50 rounded-2xl">
        {/* User Info Header */}
        ...
        <DropdownMenuItem 
          ...
          className="cursor-pointer hover:bg-rose-50 text-rose-600 focus:bg-rose-50 focus:text-rose-600 rounded-xl text-sm py-2.5 px-3 flex items-center gap-2.5 font-bold transition-colors"
        >
